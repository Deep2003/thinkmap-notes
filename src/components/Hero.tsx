    ...
    <div className="relative min-h-screen flex items-center justify-center gradient-bg text-white px-4">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        <div className="mb-8 flex flex-col items-center">
          <img src="/lovable-uploads/logo.svg" alt="Mangrove Logo" className="w-1024 h-1024" />
        ...
        <button className="bg-white text-[#34602b] px-8 py-3 rounded-full text-lg font-semibold hover:bg-gray-100 transition-colors">
          Add to Browser
        </button>
      </div>
    </div>
